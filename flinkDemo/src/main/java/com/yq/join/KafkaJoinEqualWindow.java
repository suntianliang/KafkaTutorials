 ...
 */
@Slf4j
public class KafkaJoinEqualWindow {
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<String> countsString = countsA.join(countsB)
                ...
                .apply (new JoinFunction<Tuple2<String, Integer>, Tuple2<String, Integer>, String>(){
                    ...
                    public String join(Tuple2<String, Integer> first, Tuple2<String, Integer> second) {
                        return  "(" + first.f0 + "," + first.f1 + "), （"+ second.f0 + "," + second.f1 + ")";
                    }
                });
        ...
        // execute program
        JobExecutionResult result = env.execute("Streaming Kafka2");
    ...
    private static class EqualKeySelector implements KeySelector<Tuple2<String, Integer>, String> {
        @Override
        public String getKey(Tuple2<String, Integer> value) {
            final String str = "A";
            return str;
